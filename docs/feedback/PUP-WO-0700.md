...
**Adversarial record:** `docs/findings/PUP-WO-0700-adversarial.md`.
...
in-memory, `URL.createObjectURL`, never `localStorage`, *"cache-only… because kids"*.
...
Worst disagreement **0.0104 percentage points**, across a 660px spread of rendered width
...
**The sticker was between 42% and 240% of its correct size depending on how wide the screen
happened to be.** And `36 / 600 = 6.000%` exactly — so at a 600px-wide preview the old code
